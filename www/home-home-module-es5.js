...
var HomePage = /** @class */ (function () {
    function HomePage(dataServ, cart, http, route, modalController, fsServices, menuCtrl, authService, geolocation, util) {
        var _this = this;
        this.dataServ = dataServ;
        this.cart = cart;
        this.http = http;
    ...
    HomePage.prototype.getUserSearchingStores = function () {
        var _this = this;
        this.fsServices.getUserLocalStores().then(function (data) {
            data.subscribe(function (list) {
                _this.storesList = list;
            });
    ...
    HomePage.prototype.setUserSearchCity = function (city) {
        if (this.util.userSearchingCity) {
    ...
    HomePage.prototype.goToStorePage = function (store) {
