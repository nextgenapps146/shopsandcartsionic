...
module.exports = "@charset \"UTF-8\";\n/**\n * Ionic 4  Grocery Complete Platform(https://store.enappd.com/product/ionic-4-grocery-app-and-admin-dashboard)\n *\n * Copyright © 2019-present Enappd. All rights reserved.\n *\n * This source code is licensed as per the terms found in the\n * LICENSE.md file in the root directory of this source .\n *\n */\n.input {\n  border: 0.5px solid #d2d2d2;\n  background-color: rgba(240, 240, 240, 0.5);\n  border-radius: 3px;\n  font-size: 0.9em !important;\n}\n.label {\n  font-size: 12px;\n}\n.small {\n  font-size: 9px;\n  color: #787878;\n}\n.icon {\n  font-size: 21px;\n}\n.bottom {\n  position: absolute;\n  bottom: 10px;\n  width: 90%;\n  left: 50%;\n  transform: translate(-50%, 0%);\n}\n.add-payment-div {\n  border: 1px solid #ddd;\n  ion-margin-bottom: 10px;\n  padding: 10px;\n}\n.contentSection {\n  background: #fff;\n}\n.cardContentSection {\n  display: flex;\n  align-items: center;\n}\n.cardContentSection ion-label {\n  width: 100%;\n}\n.cardImage {\n  width: 40px;\n}\n.lockSection {\n  display: flex;\n  align-items: flex-start;\n}\n.lockIcon {\n  font-size: 21px;\n  padding-right: 8px;\n}\n.secureTextSection {\n  padding-top: 5px;\n}\n.promoCodeDiv {\n  border: 2px dashed red;\n  max-width: calc(100% - 20px);\n  margin: auto;\n  ion-margin-bottom: 10px;\n}\n.promoCodeDiv ion-icon {\n  color: red;\n  margin-top: 2px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var PaymentPage = /** @class */ (function () {
    function PaymentPage(menuCtrl, dataService, alertController, route, toastCtrl, cart, fsServices, util, activeRoute, product) {
        var _this = this;
        ...
        this.activeRoute.params.subscribe(function (res) {
            _this.selectedDay = res.selectedDay;
            _this.selectedTime = res.selectedTime;
            _this.addressvalue = res.addressvalue;
        });
    }
    ...
    PaymentPage.prototype.done = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var address, promocode, i;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                address = {};
                promocode = {};
                for (i = 0; i < this.fsServices.UserAddress.length; i++) {
                ...
                if (this.fsServices.promoCodes.length) {
                    this.fsServices.promoCodes.forEach(function (offer) {
                        if (offer.code === _this.appliedPromoCode) {
                            promocode = offer;
                        }
                    });
                }
                    ...
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                this.cart.addCart.map(function (ele) {
                                    ele.units = 0;
                                });
                                this.cart.addCart = [];
    ...
    PaymentPage.prototype.removePromoCode = function () {
        this.appliedPromoCode = '';
        this.util.presentToast('Promocode removed successfully!', true, 'bottom', 2100);
        this.cart.grandTotal = 0;
        for (var i = 0; i < this.cart.addCart.length; i++) {
            var productPrice = this.cart.addCart[i].salePrice;
            this.cart.grandTotal += productPrice * this.cart.addCart[i].units;
        }
    };
    PaymentPage.prototype.applyPromoCode = function (promocode) {
        var _this = this;
        var matched = false;
        if (this.fsServices.promoCodes.length === 0) {
            this.util.openLoader();
            this.fsServices.getOffers().then(function (data) {
                data.subscribe(function (codes) {
                    if (_this.fsServices.promoCodes.length) {
                        _this.fsServices.promoCodes.forEach(function (offer) {
                            if (offer.code === promocode) {
                                matched = true;
                                _this.util.presentToast('Promocode applied successfully!', true, 'bottom', 2100);
                                _this.appliedPromoCode = promocode;
                                _this.promoCode = '';
                                _this.cart.grandTotal = 0;
                                for (var i = 0; i < _this.cart.addCart.length; i++) {
                                    var productPrice = _this.cart.addCart[i].salePrice - ((_this.cart.addCart[i].salePrice * parseInt(offer.discount)) / 100);
                                    _this.cart.grandTotal += productPrice * _this.cart.addCart[i].units;
                                }
                            }
                        });
                        if (!matched) {
                            _this.util.presentToast('Promocode is not valid!', true, 'bottom', 2100);
                        }
                    }
                    else {
                        _this.util.presentToast('No Promocode is available for now!', true, 'bottom', 2100);
                    }
                });
